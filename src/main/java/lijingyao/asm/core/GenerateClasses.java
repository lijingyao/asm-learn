...
//        Class c = new MyClassLoader().defineClass("lijingyao.asm.core.ChildClass", b);
...
//        cw.visitMethod()
        ...
        cw.visitMethod(Opcodes.ACC_PUBLIC + Opcodes.ACC_ABSTRACT, "compareTo", "(Ljava/lang/Object;)I", null, null)
                .visitEnd();
        cw.visit(Opcodes.V1_5, Opcodes.ACC_PUBLIC + Opcodes.ACC_ABSTRACT , "lijingyao/asm/core/ChildClass", null, "java/lang/Object", new String[]{"lijingyao/asm/core/ParentInter"});
        cw.visitEnd();
